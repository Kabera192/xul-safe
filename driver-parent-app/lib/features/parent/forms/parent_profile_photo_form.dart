...
class ParentProfilePhotoForm extends StatelessWidget {
...
class _UploadPlaceholder extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    const uploadTextBlue = ParentProfilePhotoForm.uploadTextBlue;
...
class _DashedUploadBox extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    const uploadBoxBg = ParentProfilePhotoForm.uploadBoxBg;
    const dashColor = ParentProfilePhotoForm.dashColor;
